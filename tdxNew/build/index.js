...
var exports_web_vitals = {};
__export(exports_web_vitals, {
  onTTFB: () => {
    {
      return Z;
    }
...
var init_web_vitals = __esm(() => {
  ...
  f = function(e2, n2) {
    ...
    return a >= 0 ? r2 = "back-forward-cache" : t2 && (document.prerendering || u() > 0 ? r2 = "prerender" : document.wasDiscarded ? r2 = "restore" : t2.type && (r2 = t2.type.replace(/_/g, "-"))), { name: e2, value: n2 === undefined ? -1 : n2, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1000000000000), navigationType: r2 };
  };
  s = function(e2, n2, t2) {
    try {
  ...
  d = function(e2, n2, t2, r2) {
    var i2, a2;
    return function(o2) {
      n2.value >= 0 && (o2 || r2) && ((a2 = n2.value - (i2 || 0)) || i2 === undefined) && (i2 = n2.value, n2.delta = a2, n2.rating = function(e3, n3) {
  ...
  b = function(e2, n2) {
    n2 = n2 || {}, C(function() {
      var t2, r2 = E(), i2 = f("FCP"), a2 = s("paint", function(e3) {
        e3.forEach(function(e4) {
          e4.name === "first-contentful-paint" && (a2.disconnect(), e4.startTime < r2.firstHiddenTime && (i2.value = Math.max(e4.startTime - u(), 0), i2.entries.push(e4), t2(true)));
        });
      });
      a2 && (t2 = d(e2, i2, L, n2.reportAllChanges), o(function(r3) {
        i2 = f("FCP"), t2 = d(e2, i2, L, n2.reportAllChanges), l(function() {
  ...
  S = function(e2, n2) {
    n2 = n2 || {}, b(v(function() {
      var t2, r2 = f("CLS", 0), i2 = 0, a2 = [], c2 = function(e3) {
        e3.forEach(function(e4) {
          if (!e4.hadRecentInput) {
            var n3 = a2[0], t3 = a2[a2.length - 1];
            i2 && e4.startTime - t3.startTime < 1000 && e4.startTime - n3.startTime < 5000 ? (i2 += e4.value, a2.push(e4)) : (i2 = e4.value, a2 = [e4]);
          }
      ...
      u2 && (t2 = d(e2, r2, w, n2.reportAllChanges), p(function() {
        ...
        i2 = 0, r2 = f("CLS", 0), t2 = d(e2, r2, w, n2.reportAllChanges), l(function() {
          return t2();
        });
      }), setTimeout(t2, 0));
    }));
  ...
  M = function(e2) {
    if (e2.cancelable) {
      var n2 = (e2.timeStamp > 1000000000000 ? new Date : performance.now()) - e2.timeStamp;
  ...
  Q = function(e2, n2) {
    n2 = n2 || {}, C(function() {
      q();
      var t2, r2 = f("INP"), i2 = function(e3) {
        e3.forEach(function(e4) {
      ...
      t2 = d(e2, r2, j, n2.reportAllChanges), a2 && (a2.observe({ type: "first-input", buffered: true }), p(function() {
        i2(a2.takeRecords()), r2.value < 0 && z() > 0 && (r2.value = 0, r2.entries = []), t2(true);
      }), o(function() {
        G = [], _ = O(), r2 = f("INP"), t2 = d(e2, r2, j, n2.reportAllChanges);
      }));
    });
  };
  U = [2500, 4000];
  ...
  W = function(e2, n2) {
    n2 = n2 || {}, C(function() {
      var t2, r2 = E(), i2 = f("LCP"), a2 = function(e3) {
...
var App = function() {
  return jsx_runtime.jsx("div", {
    ...
    role: "main",
    children: jsx_runtime.jsx("article", {
...
var reportWebVitals = (onPerfEntry) => {
  if (onPerfEntry && onPerfEntry instanceof Function) {
    Promise.resolve().then(() => (init_web_vitals(), exports_web_vitals)).then(({ getCLS, getFID, getFCP, getLCP, getTTFB }) => {
      getCLS(onPerfEntry);
      getFID(onPerfEntry);
      getFCP(onPerfEntry);
      getLCP(onPerfEntry);
...
var root = $createRoot2(document.getElementById("root"));
root.render(jsx_runtime2.jsx(React3.StrictMode, {
  children: [
    jsx_runtime2.jsx(App_default, {}),
    ","
  ]
}));
