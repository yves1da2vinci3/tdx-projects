import { Button, InputBase, LoadingOverlay, Modal, Select, Skeleton } from '@mantine/core'
...
function ModifyUserModal({setModifyUserModalStatus,ModifyUserModalStatus}) {
  ...
  return (
    <Modal  title="Modify User information" centered size="lg" onClose={()=> setModifyUserModalStatus(false)} opened={ModifyUserModalStatus}  > 
